...
function StatesAndSliderLayer({
    ...
    return (
        <>
            ...
            />
            <Slider colorScheme={'blackAlpha'} aria-label='date-time-slider' defaultValue={0} min={0} max={SLIDER_PRESENT_STEP} onChange={(val) => onSliderChange(val)} step={1} mt='575px' width='50%' ml='20%'>
                <SliderThumb ml='50px'/>

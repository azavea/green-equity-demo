"""
Django settings for actual-project-name
...
if ENVIRONMENT in ["Production", "Staging"]:
    ...
    if R53_PUBLIC_HOSTED_ZONE is None:
...
ROOT_URLCONF = "actual-project-name.urls"
...
WSGI_APPLICATION = "actual-project-name.wsgi.application"
...
# Custom user model implementing email-as-username.
# Avoid changing this setting even if reverting to Django's default
# username-as-username, as creating a custom User is recommended anyway:
# https://docs.djangoproject.com/en/stable/topics/auth/customizing/#changing-to-a-custom-user-model-mid-project
